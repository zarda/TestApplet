...
{
    public partial class FG_Simple : Form
    {
        public FG_Simple()
        {
            InitializeComponent();
        ...
        private void InitializeFG()
        {
            try
            {
                ...
                boardApplet.Add("QuadAreaGray16");
                boardApplet.Add("FrameGrabberTest");
                
                boardId.ForEach(delegate (int id) 
                {
                    boardType.Add(SiSoCsRt.Fg_getBoardType(id));
                    FG.Add(SiSoCsRt.Fg_Init(boardApplet[id], (uint)id));
                });                
